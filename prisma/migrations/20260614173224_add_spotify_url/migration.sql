...
INSERT INTO "new_Settings" ("accentColor", "adminPasswordHash", "artistName", "bpm", "consentText", "createdAt", "id", "instagramUrl", "isConfigured", "labelName", "privacyText", "updatedAt") SELECT "accentColor", "adminPasswordHash", "artistName", "bpm", "consentText", "createdAt", "id", "instagramUrl", "isConfigured", "labelName", "privacyText", "updatedAt" FROM "Settings";
DROP TABLE "Settings";
